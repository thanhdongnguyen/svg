/* eslint-disable -- Vendored wasm-bindgen output; see provenance.json and VTRACER-LICENSE-MIT. */
...
// Browser experimental adaptation: same generated imports and bindings; explicit WASM bytes initializer.
let wasm;
export async function init(bytesOrModule) {
    if (wasm) return wasm;
